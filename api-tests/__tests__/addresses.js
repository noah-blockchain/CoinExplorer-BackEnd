...
const BASE_NOAH_ADDRESS = process.env.BASE_NOAH_ADDRESS;

describe('addresses api methods', () => {
    it('get addresses', () => {
        return explorerApi.getAddresses([BASE_NOAH_ADDRESS]).then(response => {
    ...
    it('get address', () => {
        return explorerApi.getAddress(BASE_NOAH_ADDRESS).then(response => {
            expect(response.status).toEqual(200);
    ...
    it('get address transactions', () => {
        return explorerApi.getAddressTransactions(BASE_NOAH_ADDRESS).then(response => {
            expect(response.status).toEqual(200);
    ...
    it('get address transactions with filter', () => {
        return explorerApi.getAddressTransactions(BASE_NOAH_ADDRESS).then(baseResponse => {
            blockId = baseResponse.data.data[0].block;
            explorerApi.getAddressTransactions(BASE_NOAH_ADDRESS, blockId, blockId).then(response => {
                expect(response.status).toEqual(200);
                expect(response.data.data.length).toEqual(1);
                expect(ajv.validate({$ref: 'openapi.json#/components/schemas/TransactionPaginatedCollectionResponse'}, response.data)).toEqual(true);
            });
    ...
    it('get address rewards', () => {
        return explorerApi.getAddressRewards(BASE_NOAH_ADDRESS).then(response => {
            expect(response.status).toEqual(200);
    ...
    it('get address rewards with filter', () => {
        return explorerApi.getAddressRewards(BASE_NOAH_ADDRESS).then(baseResponse => {
            blockId = baseResponse.data.data[0].block;
            rowsCount = 0;
            ...
            explorerApi.getAddressRewards(BASE_NOAH_ADDRESS, blockId, blockId).then(response => {
                expect(response.status).toEqual(200);
    ...
    it('get address slashes', () => {
        return explorerApi.getAddressSlashes(BASE_NOAH_ADDRESS).then(response => {
            expect(response.status).toEqual(200);
    ...
    it('get address slashes with filter', () => {
        return explorerApi.getAddressSlashes(BASE_NOAH_ADDRESS).then(baseResponse => {
            let blockId = baseResponse.data.data[0].block;
            explorerApi.getAddressSlashes(BASE_NOAH_ADDRESS, blockId, blockId).then(response => {
                expect(response.status).toEqual(200);
                expect(response.data.data.length).toEqual(1);
                expect(ajv.validate({$ref: 'openapi.json#/components/schemas/SlashPaginatedCollectionResponse'}, response.data)).toEqual(true);
            });
    ...
    it('get address rewards statistics', () => {
        return explorerApi.getAddressRewardsStats(BASE_NOAH_ADDRESS).then(response => {
            expect(response.status).toEqual(200);
    ...
    it('get address delegations', () => {
        return explorerApi.getAddressDelegations(BASE_NOAH_ADDRESS).then(response => {
            expect(response.status).toEqual(200);
